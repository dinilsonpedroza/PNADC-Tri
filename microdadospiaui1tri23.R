...
PNADcBR <- get_pnadc(year = 2023, quarter = 1, vars = variaveis_selecionadas)
...
txdpi
# taxa de desocupação de 11,13% [bate com o que foi divulgado]
...
# número de pessoas ocupadas no Piauí = 1.245.803 [bate com o que foi divulgado]
####estou aqui
...
# nº de pessoas com 60 anos ou mais ocupadas no PI = 87.220 [bate com o que foi divulgado]
...
# Taxa de desocupação no PI = 0.1113438 [OK]
# Número de pessoas ocupadas no PI = 1245803 [OK]
# Número de pessoas ocupadas com 60 ou + no PI = 87220.3 [OK]
# Nº de mulheres pretas com 60+ ocupadas no PI = 4523.6
# Nº de mulheres brancas com 60+ ocupadas no PI = 7419.75
# Nº de homens pretos com 60+ ocupados no PI = 6933.4
# Nº de homens brancos com 60+ ocupados no PI = 15073.96
# Renda média das pessoas ocupadas no PI = R$ 2473.1
# Renda média das mulheres ocupadas no PI = R$ 2477
# Renda média dos homens ocupados no PI = R$ 2470.5
# Renda média das pessoas com 60+ ocupadas no PI = 3645.3
# Renda média das mulheres ocupadas com 60+ no PI = R$ 4553.7
# Renda média dos homens ocupados com 60+ no PI = R$ 3133.7
# Renda média de mulheres pretas ocupadas com 60+ no PI = R$ 2679.9
# Renda média de mulheres brancas ocupadas com 60+ no PI = R$ 5203.5
# Renda média dos homens pretos ocupados com 60+ no PI = R$ 1557.5
# Renda média dos homens brancos ocupados com 60+ no PI = R$ 3512.2
